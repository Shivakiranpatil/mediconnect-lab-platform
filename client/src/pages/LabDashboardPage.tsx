...
export default function LabDashboardPage() {
  ...
  const navItems = [
    ...
    { icon: Calendar, label: 'Bookings', href: '/lab/bookings', active: false },
    { icon: MapPin, label: 'Service Zones', href: '/lab/zones', active: false },
    { icon: DollarSign, label: 'Pricing', href: '/lab/pricing', active: false },
    { icon: Clock, label: 'Working Hours', href: '/lab/hours', active: false },
    { icon: FileText, label: 'Reports', href: '/lab/reports', active: false },
    { icon: Settings, label: 'Settings', href: '/lab/settings', active: false },
  ];
  ...
  return (
    <SidebarProvider style={sidebarStyle}>
      <div className="min-h-screen bg-gradient-to-br from-teal-900 via-slate-900 to-slate-900 flex w-full" data-testid="lab-dashboard">
        <Sidebar className="bg-slate-800/30 backdrop-blur-xl border-r border-slate-700/50" data-testid="lab-sidebar">
          ...
          <header className="bg-slate-800/20 backdrop-blur-xl border-b border-slate-700/50 px-8 py-6">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-4">
                <SidebarTrigger className="text-slate-400 hover:text-white" data-testid="button-lab-sidebar-toggle" />
                <div>
