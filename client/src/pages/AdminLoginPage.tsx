      ...
      <div className="container mx-auto px-4 pt-32 pb-20 flex justify-center">
        <Card className="w-full max-w-md rounded-[2rem] shadow-2xl border-none">
          <CardHeader className="text-center pb-2">
            ...
            <CardTitle className="text-3xl font-display font-bold text-slate-900">Admin Portal</CardTitle>
          ...
          <CardContent className="p-8">
            <form onSubmit={form.handleSubmit((data) => loginMutation.mutate(data))} className="space-y-6">
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <Input 
                    ...
                    id="username"
                    placeholder="admin" 
                    className="h-14 pl-12 rounded-2xl bg-slate-50 border-none focus-visible:ring-2 focus-visible:ring-blue-500 font-medium"
                  />
                </div>
              </div>
              <div className="space-y-2">
              ...
              <Button 
                ...
                className="w-full h-14 bg-blue-600 hover:bg-blue-700 text-white font-bold rounded-2xl shadow-lg shadow-blue-500/25 transition-all text-lg"
              >
                {loginMutation.isPending ? "Signing in..." : "Login to Admin Portal"}
              </Button>
            </form>
          </CardContent>
        </Card>
